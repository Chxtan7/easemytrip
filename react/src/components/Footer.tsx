    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">TripEase</h3>
            <p className="text-gray-300 mb-4">
              Book flights, hotels, and holiday packages with TripEase. Get the best deals on your travel.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/gift-cards" className="text-gray-300 hover:text-white">Gift Cards</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/investor" className="text-gray-300 hover:text-white">Investor Relations</Link></li>
              <li><Link to="/advertising" className="text-gray-300 hover:text-white">Advertising</Link></li>
